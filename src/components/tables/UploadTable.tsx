              ...
              {(page || rows)?.map((row: any, i: any) => {
                ...
                return (
                  <React.Fragment key={i}>
                    <tr
                      style={{
                        backgroundColor: selectedData?.tableSelectedData?.some(
                          (selectedRow) => {
                            ...
                            if (selectedRow?.id === row?.original?.id) {
                              if (
                                selectedStatus &&
                                selectedStatus.length === originalStatus?.length
                              ) {
                                return true;
                    ...
                    {row?.isExpanded && (
                      <TableRow data={row} toggleSelection={toggleSelection} />
                    )}
                  </React.Fragment>
                );
              })}
        ...
        <div className="flex justify-end ...">
          <div className="common-pagination">
            <Button
              ...
              role="button"
            >
              <ArrowBackIosIcon fontSize="small" style={{ width: "15px" }} />{" "}
            ...
            {Array.from(
              ...
              const isWithinRange = Math.abs(pageIndexs - currentPage) <= 2;
