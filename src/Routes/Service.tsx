...
export const updateTicketApi = (ticket_id: string, data: any) =>
  PUT(`${BASE_URL}/reports/tickets/${ticket_id}/`, data);

export const deleteTicketApi = (data: { ticket_id: any }) => {
  // Directly use ticket_id, since we expect only a single ID per request
  return DELETE(`${BASE_URL}/reports/tickets/${data.ticket_id}/`);
};
